...
-   [chat.editing.confirmEditRequestRemoval](vscode://settings/chat.editing.confirmEditRequestRemoval) - ask for confirmation before undoing an edit (default: `true`).
